...
if __name__ == "__main__":
    # Detect OS and display it
    os_type = detect_os()
    print(f"Operating System Detected: {os_type}")

    # Specify the folder to monitor (e.g., Downloads folder)
    folder_to_monitor = "/Users/gagankarnati/Downloads"  # Adjust the path for your OS
    
    print(f"Monitoring folder: {folder_to_monitor}")
    
    # Start monitoring with the AI-based classification
